...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "Serenity Spa",
    "welcome_sign": "Welcome to Serenity Spa Dashboard",
    "copyright": "Serenity Spa 2026",
}
...
CSRF_TRUSTED_ORIGINS = ['https://serenity-spa-u4lx.onrender.com']